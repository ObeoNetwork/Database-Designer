...
public class ForeignKeyMappingItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DBERMappingPackage.Literals.FOREIGN_KEY_MAPPING__FOREIGN_KEY_ELEMENT_MAPPINGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ForeignKeyMapping.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DBERMappingPackage.Literals.FOREIGN_KEY_MAPPING__FOREIGN_KEY_ELEMENT_MAPPINGS,
				 DBERMappingFactory.eINSTANCE.createForeignKeyElementMapping()));
	}
