...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.entityrelation.Join} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Join_identifiers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Join_identifiers_feature", "_UI_Join_type"),
				 EntityRelationPackage.Literals.JOIN__IDENTIFIERS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntityRelationPackage.Literals.JOIN__COLUMNS,
				 true,
				 false,
				 true,
				 null,
