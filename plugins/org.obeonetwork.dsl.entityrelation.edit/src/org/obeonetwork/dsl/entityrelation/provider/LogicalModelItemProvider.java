...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.entityrelation.LogicalModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogicalModelItemProvider
	 ...
	 * @generated
	 */
	public LogicalModelItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LogicalModel"));
	}
	...
	public String getText(Object object) {
		String label = ((LogicalModel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LogicalModel_type") :
			getString("_UI_LogicalModel_type") + " " + label;
	}
