...
public class EntityItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPrimaryIdentifierPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_primaryIdentifier_feature", "_UI_Entity_type"),
				 EntityRelationPackage.Literals.ENTITY__PRIMARY_IDENTIFIER,
				 true,
				 false,
				 true,
				 null,
