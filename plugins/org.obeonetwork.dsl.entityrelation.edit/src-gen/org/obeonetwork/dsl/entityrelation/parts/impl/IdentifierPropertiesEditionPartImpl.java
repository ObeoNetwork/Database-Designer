...
public class IdentifierPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, IdentifierPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EntityrelationMessages.IdentifierPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EntityrelationViewsRepository.Identifier.Properties.name, EntityrelationViewsRepository.SWT_KIND));
	...
	protected Composite createAttributesReferencesTable(Composite parent) {
		Label attributesLabel = SWTUtils.createPartLabel(parent, EntityrelationMessages.IdentifierPropertiesEditionPart_AttributesLabel, propertiesEditionComponent.isRequired(EntityrelationViewsRepository.Identifier.Properties.attributes, EntityrelationViewsRepository.SWT_KIND));
	...
	protected Composite createCommentsTextarea(Composite parent) {
		Label commentsLabel = SWTUtils.createPartLabel(parent, EntityrelationMessages.IdentifierPropertiesEditionPart_CommentsLabel, propertiesEditionComponent.isRequired(EntityrelationViewsRepository.Identifier.Properties.comments, EntityrelationViewsRepository.SWT_KIND));
