...
public class ForeignKeyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ForeignKeyPropertiesEditionPart basePart = (ForeignKeyPropertiesEditionPart)editingPart;
			// init values
			if (foreignKey.getName() != null && isAccessible(DatabaseViewsRepository.ForeignKey.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), foreignKey.getName()));
			...
			if (foreignKey.getComments() != null && isAccessible(DatabaseViewsRepository.ForeignKey.Properties.comments))
				basePart.setComments(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), foreignKey.getComments()));
			// init filters
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			ForeignKeyPropertiesEditionPart basePart = (ForeignKeyPropertiesEditionPart)editingPart;
			if (DatabasePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(DatabaseViewsRepository.ForeignKey.Properties.name)) {
			...
			if (DatabasePackage.eINSTANCE.getForeignKey_Target().equals(msg.getFeature()) && basePart != null && isAccessible(DatabaseViewsRepository.ForeignKey.Properties.target))
				basePart.setTarget((EObject)msg.getNewValue());
			if (DatabasePackage.eINSTANCE.getDatabaseElement_Comments().equals(msg.getFeature()) && basePart != null && isAccessible(DatabaseViewsRepository.ForeignKey.Properties.comments)){
				if (msg.getNewValue() != null) {
