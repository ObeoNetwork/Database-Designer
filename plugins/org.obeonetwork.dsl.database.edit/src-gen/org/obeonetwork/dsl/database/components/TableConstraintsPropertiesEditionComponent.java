 ...
 * 
 */
public class TableConstraintsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public TableConstraintsPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject table, String editing_mode) {
		super(editingContext, table, editing_mode);
		parts = new String[] { CONSTRAINTS_PART };
		repositoryKey = DatabaseViewsRepository.class;
		partKey = DatabaseViewsRepository.Constraints.class;
	}
