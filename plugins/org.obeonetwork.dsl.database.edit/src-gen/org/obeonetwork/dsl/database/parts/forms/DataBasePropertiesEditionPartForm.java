 ...
 * 
 */
public class DataBasePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DataBasePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DatabaseMessages.DataBasePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.DataBase_.Properties.name, DatabaseViewsRepository.FORM_KIND));
	...
	protected Composite createUrlText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DatabaseMessages.DataBasePropertiesEditionPart_UrlLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.DataBase_.Properties.url, DatabaseViewsRepository.FORM_KIND));
	...
	protected Composite createCommentsTextarea(FormToolkit widgetFactory, Composite parent) {
		Label commentsLabel = FormUtils.createPartLabel(widgetFactory, parent, DatabaseMessages.DataBasePropertiesEditionPart_CommentsLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.DataBase_.Properties.comments, DatabaseViewsRepository.FORM_KIND));
		...
		comments.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataBasePropertiesEditionPartForm.this, DatabaseViewsRepository.DataBase_.Properties.comments, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comments.getText()));
			}
