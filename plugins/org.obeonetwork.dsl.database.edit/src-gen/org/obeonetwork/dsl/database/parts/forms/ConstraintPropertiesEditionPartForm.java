...
public class ConstraintPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ConstraintPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DatabaseMessages.ConstraintPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.Constraint.Properties.name, DatabaseViewsRepository.FORM_KIND));
	...
	protected Composite createExpressionTextarea(FormToolkit widgetFactory, Composite parent) {
		Label expressionLabel = FormUtils.createPartLabel(widgetFactory, parent, DatabaseMessages.ConstraintPropertiesEditionPart_ExpressionLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.Constraint.Properties.expression, DatabaseViewsRepository.FORM_KIND));
		...
		expression.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConstraintPropertiesEditionPartForm.this, DatabaseViewsRepository.Constraint.Properties.expression, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, expression.getText()));
			}
	...
	protected Composite createCommentsTextarea(FormToolkit widgetFactory, Composite parent) {
		Label commentsLabel = FormUtils.createPartLabel(widgetFactory, parent, DatabaseMessages.ConstraintPropertiesEditionPart_CommentsLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.Constraint.Properties.comments, DatabaseViewsRepository.FORM_KIND));
		...
		comments.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConstraintPropertiesEditionPartForm.this, DatabaseViewsRepository.Constraint.Properties.comments, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comments.getText()));
			}
