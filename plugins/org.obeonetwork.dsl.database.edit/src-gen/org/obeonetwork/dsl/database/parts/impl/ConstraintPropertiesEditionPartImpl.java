...
public class ConstraintPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ConstraintPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, DatabaseMessages.ConstraintPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.Constraint.Properties.name, DatabaseViewsRepository.SWT_KIND));
	...
	protected Composite createExpressionTextarea(Composite parent) {
		Label expressionLabel = SWTUtils.createPartLabel(parent, DatabaseMessages.ConstraintPropertiesEditionPart_ExpressionLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.Constraint.Properties.expression, DatabaseViewsRepository.SWT_KIND));
		...
		expression = new Text(parent, SWT.BORDER | SWT.WRAP | SWT.MULTI | SWT.V_SCROLL);
	...
	protected Composite createCommentsTextarea(Composite parent) {
		Label commentsLabel = SWTUtils.createPartLabel(parent, DatabaseMessages.ConstraintPropertiesEditionPart_CommentsLabel, propertiesEditionComponent.isRequired(DatabaseViewsRepository.Constraint.Properties.comments, DatabaseViewsRepository.SWT_KIND));
