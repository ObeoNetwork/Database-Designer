...
import org.obeonetwork.dsl.database.components.ForeignKeyPropertiesEditionComponent;

/**
 * 
 * 
 */
public class ForeignKeyPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ForeignKeyPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ForeignKeyPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ForeignKey) 
					&& (DatabasePackage.eINSTANCE.getForeignKey() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof ForeignKey) && (refinement == ForeignKeyPropertiesEditionComponent.class);
	}
