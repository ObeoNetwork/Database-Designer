 ...
 * 
 */
public class PrimaryKeyPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public PrimaryKeyPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public PrimaryKeyPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof PrimaryKey) 
					&& (DatabasePackage.eINSTANCE.getPrimaryKey() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof PrimaryKey) && (refinement == PrimaryKeyPropertiesEditionComponent.class);
	}
