...
import org.obeonetwork.dsl.database.components.IndexPropertiesEditionComponent;

/**
 * 
 * 
 */
public class IndexPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public IndexPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public IndexPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Index) 
					&& (DatabasePackage.eINSTANCE.getIndex() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Index) && (refinement == IndexPropertiesEditionComponent.class);
	}
