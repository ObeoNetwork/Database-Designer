...
import org.obeonetwork.dsl.database.components.SchemaPropertiesEditionComponent;

/**
 * 
 * 
 */
public class SchemaPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public SchemaPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public SchemaPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Schema) 
					&& (DatabasePackage.eINSTANCE.getSchema() == editingContext.getEObject().eClass());
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Schema) && (refinement == SchemaPropertiesEditionComponent.class);
	}
