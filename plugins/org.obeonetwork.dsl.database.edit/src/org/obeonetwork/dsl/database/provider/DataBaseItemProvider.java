	...
	protected void addUsesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataBase_uses_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataBase_uses_feature", "_UI_DataBase_type"),
				 DatabasePackage.Literals.DATA_BASE__USES,
				 true,
				 false,
				 true,
				 null,
