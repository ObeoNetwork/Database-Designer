...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.database.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatabasePackage.Literals.TABLE__PRIMARY_KEY,
				 DatabaseFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(DatabasePackage.Literals.TABLE__FOREIGN_KEYS,
				 DatabaseFactory.eINSTANCE.createForeignKey()));

		newChildDescriptors.add
			(createChildParameter
				(DatabasePackage.Literals.TABLE__CONSTRAINTS,
				 DatabaseFactory.eINSTANCE.createConstraint()));
