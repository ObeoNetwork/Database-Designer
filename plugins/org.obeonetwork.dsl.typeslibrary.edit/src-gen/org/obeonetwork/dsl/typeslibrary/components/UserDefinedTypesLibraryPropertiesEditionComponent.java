...
public class UserDefinedTypesLibraryPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final UserDefinedTypesLibraryPropertiesEditionPart basePart = (UserDefinedTypesLibraryPropertiesEditionPart)editingPart;
			// init values
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			UserDefinedTypesLibraryPropertiesEditionPart basePart = (UserDefinedTypesLibraryPropertiesEditionPart)editingPart;
			if (TypesLibraryPackage.eINSTANCE.getUserDefinedTypesLibrary_Name().equals(msg.getFeature()) && basePart != null && isAccessible(TypeslibraryViewsRepository.UserDefinedTypesLibrary.Properties.name)) {
