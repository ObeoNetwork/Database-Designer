 ...
 * 
 */
public class NativeTypePropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public NativeTypePropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public NativeTypePropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof NativeType) && (refinement == NativeTypePropertiesEditionComponent.class);
	}
