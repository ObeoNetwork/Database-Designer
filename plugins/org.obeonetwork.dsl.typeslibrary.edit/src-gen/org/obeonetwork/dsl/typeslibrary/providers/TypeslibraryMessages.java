 ...
 * 
 */
public class TypeslibraryMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.obeonetwork.dsl.typeslibrary.providers.typeslibraryMessages"; //$NON-NLS-1$

	
	public static String NativeTypesLibraryPropertiesEditionPart_PropertiesGroupLabel;

	
	public static String TypeInstancePropertiesEditionPart_PropertiesGroupLabel;

	
	public static String NativeTypePropertiesEditionPart_PropertiesGroupLabel;

	
	public static String ComplexNamedTypePropertiesEditionPart_PropertiesGroupLabel;

	
	public static String SimpleNamedTypePropertiesEditionPart_PropertiesGroupLabel;

	
	public static String UserDefinedTypeRefPropertiesEditionPart_PropertiesGroupLabel;
	...
	public static String NativeTypesLibrary_Part_Title;

	
	public static String TypeInstance_ReadOnly;

	
	public static String TypeInstance_Part_Title;

	
	public static String NativeType_ReadOnly;

	
	public static String NativeType_Part_Title;

	
	public static String ComplexNamedType_ReadOnly;

	
	public static String ComplexNamedType_Part_Title;

	
	public static String SimpleNamedType_ReadOnly;

	
	public static String SimpleNamedType_Part_Title;

	
	public static String UserDefinedTypeRef_ReadOnly;

	
	public static String UserDefinedTypeRef_Part_Title;

	
	public static String UserDefinedTypesLibrary_ReadOnly;
	...
	public static String TypeInstancePropertiesEditionPart_PrecisionLabel;

	
	public static String TypeInstancePropertiesEditionPart_LiteralsLabel;
	...
	public static String ComplexNamedTypePropertiesEditionPart_TypesLabel;

	
	public static String SimpleNamedTypePropertiesEditionPart_NameLabel;

	
	public static String SimpleNamedTypePropertiesEditionPart_TypeLabel;

	
	public static String UserDefinedTypeRefPropertiesEditionPart_TypeLabel;
...
// End of user code
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, TypeslibraryMessages.class);
	}

	
	private TypeslibraryMessages() {
