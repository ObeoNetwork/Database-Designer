 ...
 * 
 */
public class UserDefinedTypeRefPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public UserDefinedTypeRefPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public UserDefinedTypeRefPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof UserDefinedTypeRef) && (refinement == UserDefinedTypeRefPropertiesEditionComponent.class);
	}
