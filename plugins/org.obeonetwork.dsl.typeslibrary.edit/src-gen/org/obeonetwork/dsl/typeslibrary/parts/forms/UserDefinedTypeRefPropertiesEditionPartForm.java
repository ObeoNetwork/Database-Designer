...
public class UserDefinedTypeRefPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, UserDefinedTypeRefPropertiesEditionPart {
	 ...
	 * 
	 */
	public UserDefinedTypeRefPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(TypeslibraryMessages.UserDefinedTypeRefPropertiesEditionPart_PropertiesGroupLabel);
		...
		type.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UserDefinedTypeRefPropertiesEditionPartForm.this, TypeslibraryViewsRepository.UserDefinedTypeRef.Properties.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getType()));
			}

		});
		type.setID(TypeslibraryViewsRepository.UserDefinedTypeRef.Properties.type);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(TypeslibraryViewsRepository.UserDefinedTypeRef.Properties.type, TypeslibraryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
