...
public class EntityrelationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EntityrelationPackage.RELATION: {
				...
				if (result == null) result = caseLogicalElement(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntityrelationPackage.ATTRIBUTE: {
				...
				if (result == null) result = caseLogicalElement(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Logical Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Logical Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLogicalModel(LogicalModel object) {
		return null;
	}
